export default function HowToUse() {
  return (
    <div className="flex flex-col items-center justify-center py-16 text-pretty container">
      <h1 className="m-4 text-4xl font-black md:text-5xl">Focus Fox</h1>
      <h2 className="mb-10 text-xl font-bold text-muted-foreground md:text-2xl md:mb-20">
        Your Go-To Online Timer for Enhanced Productivity
      </h2>
      <h3 className="text-2xl font-extrabold md:text-3xl">What is Focus Fox?</h3>
      <p className="mb-10 w-11/12 pt-4 font-semibold text-muted-foreground md:w-8/12 md:mb-20">
      ...
      <ol className="m-4 w-11/12 list-decimal pl-6 font-semibold text-muted-foreground md:w-8/12">
